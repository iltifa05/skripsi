			...
			<div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Laporan Pengaduan Dalam Proses</h4>
										...
										<div class="row mt-4">
											<div class="col-lg-12 col-md-12">
												<?php if(isset($_GET['submit'])) { ?>
													...
													<?php if(isset($_GET['tipe'])) { ?>
														...
														<?php if($_GET['tipe'] == "pertanggal") { 
															...
															$to = $_GET['to']; 
															?>
															<a href="print/c-proses?tipe=pertanggal&from=<?= $from; ?>&to=<?= $to; ?>" target="_blank" class="btn btn-success">
														...
														<?php }else if($_GET['tipe'] == "perbulan") { 
															...
															$tahun = $_GET['tahun'];
															?>
															<a href="print/c-proses?tipe=perbulan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else if($_GET['tipe'] == "pertahun") { 
															$tahun = $_GET['tahun'];
															?>
															<a href="print/c-proses?tipe=pertahun&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else { ?>
															<a href="print/c-proses" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php } ?>
												...
												<?php }else { ?>
													...
													<?php } ?>
													<a href="laporan-proses" class="btn btn-warning">
