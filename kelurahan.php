							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="tambah-kelurahan" class="btn btn-primary btn-round ml-auto">
												...
												while($row = mysqli_fetch_array($query)) {
													...
													<tr>
														...
														<td align="center" style="white-space: nowrap;">
															<a href="detail-kelurahan?id=<?= $row['id_kelurahan'];?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
															<a href="" class="btn btn-danger btn-sm" id="delete-data" data-id="<?= $row['id_kelurahan'];?>"><i class="fas fa-trash-alt"></i></a>
														</td>
													</tr>
												<?php } ?>
											</tbody>
				...
				var initDemos = function() {
					swal({
						...
						if (willDelete) {
							$.ajax({
								type: "POST",
								url: "proses/delete-kelurahan.php",
								data: {'id':id},
