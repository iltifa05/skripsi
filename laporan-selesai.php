			...
			<div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Laporan Pengaduan Selesai Di Proses</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="pengaduan">Laporan Pengaduan Dalam Proses</a>
							</li>
						</ul>
					</div>
										...
										<div class="row mt-4">
											<div class="col-lg-12 col-md-12">
												<?php if(isset($_GET['submit'])) { ?>
													...
													<?php if(isset($_GET['tipe'])) { ?>
														...
														<?php if($_GET['tipe'] == "pertanggal") { 
															...
															$to = $_GET['to']; 
															?>
															<a href="print/c-selesai?tipe=pertanggal&from=<?= $from; ?>&to=<?= $to; ?>" target="_blank" class="btn btn-success">
														...
														<?php }else if($_GET['tipe'] == "perbulan") { 
															...
															$tahun = $_GET['tahun'];
															?>
															<a href="print/c-selesai?tipe=perbulan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else if($_GET['tipe'] == "pertahun") { 
															$tahun = $_GET['tahun'];
															?>
															<a href="print/c-selesai?tipe=pertahun&tahun=<?= $tahun; ?>" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php }else { ?>
															<a href="print/c-selesai" target="_blank" class="btn btn-success">
																<i class="fas fa-print"></i>
															</a>
														<?php } ?>
												...
												<?php }else { ?>
													...
													<?php } ?>
													<a href="laporan-selesai" class="btn btn-warning">
													...
													<table class="display table table-striped table-hover datatables" id="table-1">
														...
														<tbody>
															...
															while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
																$ket = array();
																$query_jumlah2 = mysqli_query($conn, "SELECT * FROM tb_kelurahan, tb_pengaduan, tb_kecamatan, tb_bidang, tb_jadwal, tb_pembagian, tb_hasil WHERE tb_kelurahan.fk_kecamatan=tb_kecamatan.id_kecamatan AND tb_pengaduan.id_kelurahan = tb_kelurahan.id_kelurahan AND tb_pengaduan.id_bidang = tb_bidang.id_bidang AND tb_jadwal.id_pengaduan = tb_pengaduan.id_pengaduan AND tb_pembagian.id_jadwal = tb_jadwal.id_jadwal AND tb_hasil.id_pembagian = tb_pembagian.id_pembagian AND tb_pengaduan.id_pengaduan='$row[id_pengaduan]' AND status_hasil='Selesai'");
																while($row_jumlah2 = mysqli_fetch_array($query_jumlah2)){
																	$ket[] = $row_jumlah2['keterangan_hasil'];
																}
