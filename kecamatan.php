							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="tambah-kecamatan" class="btn btn-primary btn-round ml-auto">
									...
									<div class="table-responsive">
										<table class="display table table-striped table-hover datatables"	>
											...
											<tbody>
												<?php 
												$no = 1;
												$query = mysqli_query($conn, "SELECT * FROM tb_kecamatan ORDER BY nama_kecamatan ASC");
												while($row = mysqli_fetch_array($query)) {
													...
													<tr>
														...
														<td align="center" style="white-space: nowrap;">
															<a href="detail-kecamatan?id=<?= $row['id_kecamatan'];?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
															<a href="" class="btn btn-danger btn-sm" id="delete-data" data-id="<?= $row['id_kecamatan'];?>"><i class="fas fa-trash-alt"></i></a>
														</td>
													</tr>
												<?php } ?>
											</tbody>
				...
				var initDemos = function() {
					swal({
						...
						if (willDelete) {
							$.ajax({
								type: "POST",
								url: "proses/delete-kecamatan.php",
								data: {'id':id},
